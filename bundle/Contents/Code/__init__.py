...
from Code.Classes.TeamList import *
# from Code.Classes.Menus import MainMenu

teams = TeamList(C["TEAMS"])
...
def Start():
  ...
  Plugin.AddPrefixHandler(C["PLUGIN_PREFIX"], MainMenu, C["PLUGIN_NAME"], 'icon-default.png', 'art-default.jpg')
